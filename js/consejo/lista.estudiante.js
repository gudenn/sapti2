		...
		rowSelected = function(oldRowIndex, newRowIndex) {
			if (oldRowIndex < 0) displayMessage("Selecionada Fila '" + this.getRowId(newRowIndex) + "'");
                ...
                setCellRenderer("action", new CellRenderer({render: function(cell, value) {
		              cell.innerHTML += "<br><a onclick=document.location.href='registro.php?estudiante_id="+getRowId(cell.rowIndex)+"' style=\"cursor:pointer\">" +
					 	 "<img src=\"" + image("asignar.png") + "\" border=\"0\" alt=\"revisar\" title=\"Asignar Tribunal\"/>Asignar Tribunal</a>";
...
EditableGrid.prototype.onloadXML = function(url) 
{
	...
	this.tableLoaded = function() { 
		displayMessage("Numero de Estudiantes " + this.getRowCount()); 
		this.initializeGrid();
	};
