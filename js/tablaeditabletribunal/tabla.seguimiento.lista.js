...
EditableGrid.prototype.initializeGrid = function() 
{
	with (this) {
		...
		cell.innerHTML = "<a onclick=document.location.href='revision.lista.php?estudiente_id="+getRowId(cell.rowIndex)+"' style=\"cursor:pointer\">" +
                ...
                cell.innerHTML += "&nbsp;<a onclick=document.location.href='revision.corregido.lista.php?estudiente_id="+getRowId(cell.rowIndex)+"' style=\"cursor:pointer\">" +
						 "<img src=\"" + image("editar.png") + "\" border=\"0\" alt=\"correccion\" title=\"Lista de Correcciones Resividas\"/>Correcciones</a>";
                   		}}));
...
EditableGrid.prototype.onloadXML = function(url) 
{
	...
	this.tableLoaded = function() { 
		displayMessage("Número de Estudiantes Asignados " + this.getRowCount()); 
		this.initializeGrid();
	};
