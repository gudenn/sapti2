...
where   u.id=e.usuario_id and e.id=pe.estudiante_id and pe.proyecto_id=p.id and p.`id`=pt.`proyecto_id` and t.`id`= pt.`proyecto_id` and t.`usuario_id`=d.`usuario_id` and d.`id`="'.$docid.'"');
$mysqli->close();
