...
where   u.id=e.usuario_id and e.id=pe.estudiante_id and  p.`tipo_proyecto`="PR" and  pe.proyecto_id=p.id and p.id=pt.proyecto_id
 and t.id= pt.proyecto_id and t.usuario_id="'.$docid.'"');
$mysqli->close();
