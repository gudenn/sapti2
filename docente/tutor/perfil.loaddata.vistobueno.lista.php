...
from  usuario u , estudiante e, proyecto_estudiante pe, proyecto p, proyecto_tutor pt , tutor  t, visto_bueno_tutor v
where   u.id=e.usuario_id and e.id=pe.estudiante_id and  pe.proyecto_id=p.id and p.id=pt.proyecto_id
and pt.tutor_id=t.id  and pt.estado_tutoria="AC" and  p.tipo_proyecto="PE"  and v.proyecto_id=p.id  and v.tutor_id="'.$idtutor.'" and t.usuario_id="'.$docid.'"');
$mysqli->close();
