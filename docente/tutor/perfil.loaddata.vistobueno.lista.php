...
and pt.tutor_id=t.id  and pt.estado_tutoria="AC" and  p.tipo_proyecto="PE"  and v.visto_bueno_tipo="TU"  and v.proyecto_id=p.id  and v.visto_bueno_id="'.$idtutor.'" and t.usuario_id="'.$docid.'"');
$mysqli->close();
