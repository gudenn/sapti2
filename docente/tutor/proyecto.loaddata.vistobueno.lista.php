...
and pt.tutor_id=t.id  and pt.estado_tutoria="AC" and  p.tipo_proyecto="PR" and t.id=v.visto_bueno_id and p.id=v.proyecto_id and v.visto_bueno_tipo="TU" and t.id="'.$idtutor.'"');
$mysqli->close();
