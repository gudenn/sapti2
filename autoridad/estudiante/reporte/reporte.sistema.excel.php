...
//$semestre= $_GET['id_p'];
$semestre= $_GET['id_p'];
$consulta='select u.nombre as NOMBRE ,CONCAT(u.apellido_paterno," ",u.apellido_materno) as APELLIDOS ,m.nombre as MATERIA,COUNT(materia_id) as INSCRITOS
   ...
   GROUP BY m.nombre';
	  ...
	  $resultado =mysql_query($consulta); 
		...
		header('Content-Disposition: attachment;filename="ReporteDocente.xlsx"');
