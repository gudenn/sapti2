...
=s.id AND e.id=pe.estudiante_id AND pe.proyecto_id=p.id and and p.tipo_proyecto='PE' AND p.estado='AC' AND p.id=v.proyecto_id AND v.estado_vigencia='PO' and s.id='".$p."'";
