<?php
   require('../_start.php');
	...
	$consulta = "SELECT s.codigo as gestion,CONCAT(u.nombre,' ',apellido_paterno,' ',apellido_materno) as nombre ,p.nombre as titulo,v.estado_vigencia as estadop,p.id
        ...
        WHERE u.id=e.usuario_id AND e.id=i.estudiante_id and p.estado_proyecto='IN' and d.semestre_id=s.id and i.dicta_id=d.id AND e.id=pe.estudiante_id AND pe.proyecto_id=p.id and p.tipo_proyecto='PR' AND p.estado='AC' AND p.id=v.proyecto_id AND v.estado_vigencia='PR' and s.id='".$p."'";
