...
=s.id AND e.id=pe.estudiante_id AND pe.proyecto_id=p.id AND p.estado='AC' AND p.id=v.proyecto_id and p.tipo_proyecto='PE' AND v.estado_vigencia='PO' and s.id='".$p."'";
