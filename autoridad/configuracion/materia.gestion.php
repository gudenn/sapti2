...
try {
  ...
  $menuList[]     = array('url'=>URL . Administrador::URL . 'configuracion/'.basename(__FILE__),'name'=>'Gesti&acoute;n de Materia');
...
if(isset($_SESSION['estado']) && $_SESSION['estado']==1)
{
  ...
  $html  = new Html();
    ...
    $html = new Html();
      ...
      $mensaje = array('mensaje'=>'Se grabo correctamente la Materia','titulo'=>'Registro de Materia' ,'icono'=> 'tick_48.png');
