...
try {
  ...
  $menuList[]     = array('url'=>URL . Administrador::URL . 'configuracion/'.basename(__FILE__),'name'=>'Gesti&oacute;n de Grupo');
...
if(isset($_SESSION['estado']) && $_SESSION['estado']==1)
{
  ...
  $html  = new Html();
    ...
    $html = new Html();
      ...
      $mensaje = array('mensaje'=>'Se grab&oacute; correctamente el Grupo','titulo'=>'Registro de Grupo' ,'icono'=> 'tick_48.png');
