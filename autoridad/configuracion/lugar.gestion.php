...
try {
  ...
  $menuList[]     = array('url'=>URL . Administrador::URL . 'configuracion/'.basename(__FILE__),'name'=>'Registro de el Lugar');
 ...
 // $smarty->assign('CSS',$CSS);
  ...
  $smarty->assign('lista'       ,'admin/lugar/lista.tpl');
  ...
  $smarty->assign("crear_nuevo"  ,"lugar.registro.php");
 $ERROR = ''; 
if(isset($_SESSION['estado']) && $_SESSION['estado']==1)
{
  ...
  $html  = new Html();
    ...
    $html = new Html();
      ...
      $mensaje = array('mensaje'=>'Se grabo correctamente el Lugar de Defensa','titulo'=>'Registro de Lugar de Defensa' ,'icono'=> 'tick_48.png');
