...
try {
 ...
 // $smarty->assign('CSS',$CSS);
  ...
  $smarty->assign("crear_nuevo"  ,"carrera.registro.php");
 $ERROR = ''; 
...
{ 
  ...
  $html  = new Html();
    ...
    $html = new Html();
      ...
      $mensaje = array('mensaje'=>'Se grab&oacute; correctamente la Carrera','titulo'=>'Registro de Carrera' ,'icono'=> 'tick_48.png');
