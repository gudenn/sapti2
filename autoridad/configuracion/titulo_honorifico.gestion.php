...
try {
 ...
 $smarty->assign("crear_nuevo"  ,"titulo_honorifico.registro.php");
 $ERROR = ''; 
if(isset($_SESSION['estado']) && $_SESSION['estado']==1)
{
  ...
  $html  = new Html();
    ...
    $html = new Html();
      ...
      $mensaje = array('mensaje'=>'Se grab&oacute; correctamente el T&iacute;tulo-Honorifico','titulo'=>'Registro de Titulo' ,'icono'=> 'tick_48.png');
