...
try {
    ...
    if (isset($_SESSION['estado']) && $_SESSION['estado'] == 1) {
        $html = new Html();
        if ($_SESSION['se_asigno_correctamente']){
            $mensaje = array('mensaje'=>'Se asign&oacute correctamente '. $_SESSION['nuevotutor'] .' como Tutor','titulo'=>'Registro de Tutor' ,'icono'=> 'tick_48.png');
        }
        else {
            $mensaje = array('mensaje'=>'Hubo un problema, No se grabo correctamente el Tutor, alcanzo el total m&aacute;ximo de tutores','titulo'=>'Registro de Tutor' ,'icono'=> 'warning_48.png');
        }
