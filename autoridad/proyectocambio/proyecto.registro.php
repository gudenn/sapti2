...
try {
 ...
 if (!defined('TIPO'))
    define ('TIPO', 'PR');
  /** HEADER */
  $smarty->assign('title','SAPTI - Registro de Cambio');
  $smarty->assign('description','Formulario de registro de Cambio');
  ...
  */
  ...
  $menuList[]     = array('url'=>URL . Administrador::URL . 'estudiante/','name'=>'Proyecto Cambio');
  $menuList[]     = array('url'=>URL . Administrador::URL . 'estudiante/'.basename(__FILE__),'name'=>'Registro de Cambio');
  ...
  $proyectoest=$estudiante->getProyecto();
