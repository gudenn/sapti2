  ...
  <tbody>
    <tr  class="{cycle values="light,dark"}" >
      ...
      <td>
        ...
        <br><a href="../tribunal/avance.detalle.php?avance_id={$objs[ic][0]}&estudiente_id={$estudiante->id}" target="_self" >Revisar {icono('basicset/document_pencil.png','Detalle')}</a>
      </td>
      {if $objs[ic][4]=='NO'}
