...
<table class="tbl_lista">
  ...
  <tbody>
    <tr  class="{cycle values="light,dark"}">
      ...
      <td>{if $avances[ic]['correcionrevision'] > 0}
            <a href="avance.detalle.php?estudiente_id={$estudiante->id}&avance_id={$avances[ic]['id']}" style="cursor:pointer">{icono('basicset/cabinet.png','Detalle')}Detalle de Correccion</a>
          {else}
            <a href="avance.detalle.php?estudiente_id={$estudiante->id}&avance_id={$avances[ic]['id']}" style="cursor:pointer">{icono('basicset/cabinet.png','Detalle')}Detalle de Avance</a>
          {/if}
      </td>    
    </tr>
  </tbody>
