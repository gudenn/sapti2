...
<!-- En "onsubmit" escribimos la funci�n 'MostrarConsulta' que creamos en javascript, con su parametro que es el archivo que vamos a mostrar, en este caso 'consulta.php'-->
 <form action="#" method="post" id="registro" name="registro" >
  ...
  <tr>
    ...
    <th><a>APELLIDOS     </a></th>
    <th><a>MATERIA</a></th>
    <th><a>ESTUDIANTES INSCRITOS</a></th>
  ...
  {/section}
         ...
         <center> 
 <a href="../../reportesistema/reportes.sistema.pdf.php?sql={$sqle}" target="_blank" >{icono('filepd.png','descargar')}descargar pdf</a>
 <a href="../../reportesistema/reporte.sistema.excel.php?sql={$sqle}" target="_blank" >{icono('boton_excel.png','descargar')}descargar excel</a>
</center>
</div> 
</body>
