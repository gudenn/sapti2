...
<div style="width: 100%;float: left;" class="tbl_filtro">
  ...
  {/section}
     ...
     <center>
      <a href="prorroga-pdf.php?id_p={$semestre->id}" target="_blank" >{icono('filepd.png','descargar')}descargar pdf</a>
        <a href="prorrogaexcel.php?id_p={$semestre->id}" target="_blank" >{icono('boton_excel.png','descargar')} descargar excel</a>
</center>
</div> 
</body>
