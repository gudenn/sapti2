<table class="tbl_lista">
  ...
  <tbody>
    <tr  class="{cycle values="light,dark"}">
      ...
      <td>
        <a href="dia.registro.php?dia_id={$objs[ic]['id']}" >{icono('basicset/pencil_48.png','Editar')} Editar</a>
        <a href="dia.gestion.php?eliminar=1&dia_id={$objs[ic]['id']}" onclick="return confirm('Eliminar este Evento?');"  >{icono('borrar.png','Eliminar')}</a>
      </td>
    </tr>
  </tbody>
  {/section}
