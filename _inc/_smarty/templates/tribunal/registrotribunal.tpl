...
Se le asignó como tribunal del proyecto “{$proyectobuscado->nombre}“  del universitario(a) :  {$usuariobuscado->getNombreSinTitulo()} para que usted realize las funciones como tribunal al proyecto ya mencionado, esperamos su pronta respuesta 
      </textarea>
        <script>
