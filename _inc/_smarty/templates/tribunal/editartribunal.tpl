...
Se le asigno como tribunal al proyecto: {$proyecto->nombre}  del Universitario: {$usuario->getNombreCompleto()} para que usted realice las funciones como tribunal al proyecto ya mencionado, esperamos su pronta respuesta. 
      </textarea>
        <script>
