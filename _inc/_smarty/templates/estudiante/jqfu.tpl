...
<!-- jQuery UI styles -->
{/literal}
<link rel="stylesheet" href="{$URL_JS}ui/overcast/jquery-ui.css" id="theme">
<!-- Demo styles -->
<link rel="stylesheet" href="{$URL_JS}jQfu/css/demo.css">
<!--[if lte IE 8]>
...
<link rel="stylesheet" href="{$URL_JS}jQfu/css/jquery.fileupload-ui.css">
<!-- CSS adjustments for browsers with JavaScript disabled -->
<noscript><link rel="stylesheet" href="{$URL_JS}jQfu/css/jquery.fileupload-ui-noscript.css"></noscript>
{literal}
</head>
<body>
...
<script src="http://localhost/sapti/js/jquery.min.js"></script>
<script src="http://localhost/sapti/js/ui/jquery-ui.min.js"></script>
{/literal}
