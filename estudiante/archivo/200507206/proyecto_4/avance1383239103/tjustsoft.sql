/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     10/29/2013 5:33:58 AM                        */
/*==============================================================*/
...
drop table if exists datos_entrada;

drop table if exists datos_salida;

drop table if exists datos_salidarespuesta;

drop table if exists entity_22;
...
drop table if exists nota_olimpista;
...
drop table if exists solucionario;
...
/*==============================================================*/
/* Table: nota_olimpista                                        */
/*==============================================================*/
create table nota_olimpista
(
   id_notaolimpista     int not null auto_increment,
   id_respuesta         int,
   nota_olimpista       int,
   primary key (id_notaolimpista)
);
...
alter table entity_22 add constraint fk_relationship_29 foreign key (id_entrenamiento)
      references entrenamiento (id_entrenamiento) on delete restrict on update restrict;
...
alter table nota_olimpista add constraint fk_relationship_30 foreign key (id_respuesta)
      references respuesta (id_respuesta) on delete restrict on update restrict;
