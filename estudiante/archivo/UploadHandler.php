...
class UploadHandler
{
    ...
    protected $error_messages = array(
        1 => 'El archivo sobrepasa el limite de tama&ntilde;o',
        2 => 'El archivo sobrepasa el limite de tama&ntilde;o',
        3 => 'El archivo fue parcialmente grabado',
        4 => 'Ningun archivo fue subido',
        6 => 'Falta el folder',
        7 => 'No se pudo grabar el archivo',
        8 => 'PHP paro el registro del archivo',
        'post_max_size' => 'El archivo sobrepasa el limite de tama&ntilde;o',
        'max_file_size' => 'El archivo es muy grande',
        'min_file_size' => 'El archivo es muy peque&ntilde;o',
        'accept_file_types' => 'El tipo de archivo no esta permitodo (Comprimalo en un .zip)',
        'max_number_of_files' => 'Supero el maximo de archivos (Comprimalo en un .zip)',
        'max_width' => 'La imagen ecxede el ancho maximo',
        'min_width' => 'La imagen es muy peque&ntilde;a',
