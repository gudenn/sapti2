...
$result = $mysqli->query('
SELECT DISTINCT (p.id) as id ,es.codigo_sis, u.nombre ,CONCAT(u.apellido_paterno,u.apellido_materno) as apellidos, p.nombre as nombrep
...
and p.estado_proyecto="TA" and p.tipo_proyecto="PR"
