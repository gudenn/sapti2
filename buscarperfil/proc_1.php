...
WHERE u.id=e.usuario_id AND e.id=i.estudiante_id AND i.semestre_id=s.id and p.tipo_proyecto='PR' and p.estado_proyecto='CO' AND e.id=pe.estudiante_id AND pe.proyecto_id=p.id 
AND (
p.nombre LIKE  '%$q%'
